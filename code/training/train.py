...
if __name__ == '__main__':
    ...
    # CNN - valid/invalid
    # python code/training/train.py --analysis_directory 'data/valid_invalid_analysis' --segmentation_value 1 --downsampling_value 1 --epochs 200 --model 'cnn' --batch 32 --task 1
    # CNN - awake/sleep
    # python code/training/train.py --analysis_directory 'data/awake_sleep_analysis' --segmentation_value 1 --downsampling_value 1 --epochs 200 --model 'cnn' --batch 32 --task 2

    # LSTM - valid/invalid
    # python code/training/train.py --analysis_directory 'data/valid_invalid_analysis' --segmentation_value 1 --downsampling_value 1 --epochs 200 --model 'lstm' --batch 32 --task 1
    # LSTM - awake/sleep
    # python code/training/train.py --analysis_directory 'data/awake_sleep_analysis' --downsampling_value 1 --epochs 200 --model 'lstm' --batch 32 --stateful --task 2
