...
if __name__ == '__main__':
    ...
    # ht_lstm()
    # sequence_test(model_path=os.path.dirname(os.path.abspath('runscript.py')) + '/models/cnn/saved_model')

    train_LSTM(load_flag=False, create_flag=True)
    # ht_cnn()
    # sequence_test(model_path=os.path.dirname(os.path.abspath('runscript.py')) + '/models/lstm/saved_model')
