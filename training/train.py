...
def train(model, analysis_directory, segmentation_value, downsampling_value, epochs, num_class, data_balancing, neighbors):
    ...
    if model.lower() == 'cnn' or model.lower() == 'lstm':
        ann_train_model(analysis_directory=analysis_directory, model=model.lower(), segmentation_value=segmentation_value, downsampling_value=downsampling_value, epochs=epochs, num_class=num_class, data_balancing=data_balancing, log_time=log_time)
...
if __name__ == '__main__':
    ...
    # LSTM
    # binary
    # python3 training/train.py --analysis_directory 'training/data/analysis' --segmentation_value 1 --downsampling_value 1 --epochs 20 --num_class 2 --model 'lstm' --no_balance
    # multinomial
    # python3 training/train.py --analysis_directory 'training/data/analysis' --segmentation_value 15 --downsampling_value 1 --epochs 50 --num_class 3 --model 'lstm' --no_balance
