...
def evaluate_model(analysis_directory, segmentation_value, downsampling_value, neighbors, data_balancing, log_time):
    """
    ...
    os.mkdir(save_dir)
    X_train, y_train, X_test, y_test = Preprocessing(analysis_directory=analysis_directory, segmentation_value=segmentation_value, downsampling_value=downsampling_value, data_balancing=data_balancing, log_time=log_time).create_dataset()
...
def train_model(analysis_directory, segmentation_value, downsampling_value, neighbors, data_balancing, log_time):
    """
    ...
    score = evaluate_model(analysis_directory, segmentation_value, downsampling_value, neighbors, data_balancing, log_time)
    score = score * 100.0
    print('score:', score, '%')
    print('-----')
